...
<?= caption(txt('33').'&nbsp;'.$oma->current_user->get_used_regexp().'/'.$oma->current_user->max_regexp, getPageList('<a href="'.mkSelfRef(array('regx_page' => '%d')).'">%d</a>', $oma->current_user->get_used_regexp(), $_SESSION['limit'], $_SESSION['offset']['regx_page']), 580) ?>
