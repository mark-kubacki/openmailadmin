...
<div class="setup_body">
	...
	<tr>
		<td>DSN</td>
		<td><input type="text" value="" /><span class="ajax_ok">OK</span></td>
	</tr>
	</table>
	...
	<tr>
		<td>type</td>
		<td><select><option value="cyrus">Cyrus imapd</option><option value="fake-cyradm">demo - mysql backend</option></select></td>
	</tr>
	<tr>
		<td>host</td>
		<td><input type="text" value="" title="127.0.0.1" /></td>
	</tr>
	<tr>
		<td>port</td>
		<td><input type="text" value="" title="143" /></td>
	</tr>
	<tr>
		<td>admin user</td>
		<td><input type="text" value="" title="i.e. 'cyrus'" /></td>
	</tr>
	<tr>
		<td>password</td>
		<td><input type="text" value="" title="i.e. '<?= md5(time().rand()) ?>'" /></td>
	</tr>
	<tr>
		<td>mailbox of superuser</td>
		<td><input type="text" value="" title="i.e. 'admin'" /></td>
	</tr>
	<tr>
		<td>password</td>
		<td><input type="text" value="" title="i.e. 'supersecret'" /></td>
	</tr>
	</table>

	<h3>next step</h3>
	<p>Please make sure you have JavaScript enabled and a green OK shows up next to your DSN.</p>
	<div class="next_step"><a href="setup.php?step=2" title="next step">proceed to step 3</a></div>
</div>