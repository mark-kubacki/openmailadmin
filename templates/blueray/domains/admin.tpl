...
<div id="admin_panel">
	...
	<dl>
		...
		<dd><?= $input->_generate('text', 'owner', $oma->current_user['mbox'], array('class' => 'textwhite', 'style' => 'width: 98%', 'maxlength' => '16')) ?></dd>
	</dl>
	<dl>
		<dt><?= $input->checkbox('change[]', 'a_admin') ?><?= txt('57') ?></dt>
		<dd><?= $input->_generate('text', 'a_admin', $oma->current_user['mbox'], array('class' => 'textwhite', 'style' => 'width: 98%')) ?></dd>
	</dl>
	<dl>
		<dt><?= $input->checkbox('change[]', 'categories') ?><?= txt('58') ?></dt>
		<dd><?= $input->_generate('text', 'categories', 'all, '.$oma->current_user['mbox'], array('class' => 'textwhite', 'style' => 'width: 98%', 'maxlength' => '100')) ?></dd>
	</dl>
